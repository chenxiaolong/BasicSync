...
package com.chiller3.basicsync.ui
...
import com.chiller3.basicsync.ui.theme.Icons
...
fun AppScreen(
    ...
    Scaffold(
        ...
        if (fullScreenContent) {
            ...
            outerPadding = contentPadding.copy(start = 0.dp, end = 0.dp, bottom = 0.dp)
            innerPadding = contentPadding.copy(top = 0.dp)
        }
